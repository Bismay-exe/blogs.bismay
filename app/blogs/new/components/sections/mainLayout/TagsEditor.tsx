...
const TagsEditor: React.FC<TagsEditorProps> = ({ tags, onTagsChange }) => {
    ...
    return (
        <div className="space-y-3 py-2">
            <div className="flex items-center gap-2 flex-wrap min-h-[42px] p-2 rounded-2xl border border-sec/20 bg-fg/[0.02] focus-within:border-accent/60 transition-colors">
